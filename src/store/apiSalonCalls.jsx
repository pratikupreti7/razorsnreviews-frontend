...
export const fetchSalonsAsync = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get('/api/salon', config)
...
export const fetchSalonsByIdAsync = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/salon/${id}`, config)
...
export const deleteSalonsByIdAsync = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`/api/salon/${id}`, config)
...
export const addSalonAsync = (salonData) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post('/api/salon', salonData, config)
...
export const fetchSalonsByUserAsync = (userId) => async (
  ...
  try {
    ...
    const { data } = await axios.get(`/api/salon/user/${userId}`, config)
